...
Steps2.defaultProps = {
  step3Description:
    'Our experienced team will bring the design to life with high-quality materials and skilled craftsmanship.',
  step4Title: 'Final Inspection',
  step4Description:
    'We conduct a thorough inspection to ensure that every detail meets our standards and your expectations.',
  step2Description:
    'Collaborate with our architects and designers to create a customized plan for your dream home.',
  step3Title: 'Construction Phase',
  step1Title: 'Initial Consultation',
  step2Title: 'Design Planning',
  step1Description:
    'Schedule a meeting with our team to discuss your housing construction needs and preferences.',
}
